...
public class CustomerOrder implements AgentAction{
	...
	private boolean builtAndShipped = false;
	...
	public boolean isBuiltAndShipped() {
		return builtAndShipped;
	}
	public void setBuiltAndShipped(boolean builtAndShipped) {
		this.builtAndShipped = builtAndShipped;
	}
